  ...
  return (
    <div className=''>
      ...
      <div className=" h-[150px] self-center">
        <Image width={100} height={100} className="" src ={user.image} alt="pic" />
      </div>
     <div className="py-2 md:py-4">
     <div className="flex flex-col md:flex-row md:justify-between">
      <div className=" ">
        <p className="font-semibold align-middle text-base pb-1 md:pb-2">{user.title}</p>
      <p className="font-semibold align-middle text-lg pb-1 md:pb-2">$ {user.price}</p>
      </div>
